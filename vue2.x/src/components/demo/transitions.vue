<template>
    <div class="transitions">
        <div class="page__hd">
            <h1 class="page__title">Transitions</h1>
            <p class="page__desc">Hiển thị dữ liệu khác nhau dựa trên các điều kiện khác nhau</p>
        </div>
        ...
        <div class="page__hd">
            ...
            <p class="page__desc">Shuffle các kí tự</p>
        </div>
